...
<head>
    ...
    if($_POST['n'] =="" or $_POST['p']=="" or $_POST['ps']=="" or $_POST['mdp1']=="" or $_POST['mdp2']=="" or $_POST['mail']=="" or $_POST['mdp1'] != $_POST['mdp2']){
        echo "<meta http-equiv='refresh' content='3;url=nouveau.php?n=".$_POST['n']."&p=".$_POST['p']."&ps=".$_POST['ps']."&mail=".$_POST['mail']."' />";}
    else{
...
?>
<div>
<p class="centrer" style="padding:100px">Veuillez patienter, profitez de ce gif ! </p>
</div>
<?php
